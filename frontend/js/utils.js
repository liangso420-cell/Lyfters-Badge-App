    ...
    root.innerHTML =
      '<div id="ach-overlay" class="fixed inset-0 z-[70] flex items-center justify-center p-6 anim-fade" style="background:rgba(17,24,39,0.8);">' +
        '<div class="bg-white rounded-card p-8 text-center w-full max-w-xs shadow-soft anim-pop" style="border-top:5px solid ' + rs.color + ';">' +
          ...
          '<div style="text-align:center;margin:0 auto 16px;filter:drop-shadow(0 0 14px ' + rs.glow + ');">' +
            '<img src="' + iconSrc + '" style="width:80px;height:80px;object-fit:contain;display:block;margin:0 auto;" onerror="this.src=\'assets/icons/achievements/primer-paso.png\'" />' +
          '</div>' +
